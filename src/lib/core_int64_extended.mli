...
module Core_int64_extended :
  sig
    ...
    module O = Core_kernel__Core_int64.O
    val of_int : int -> t
    ...
    module Hex = Core_kernel__Core_int64.Hex
    ...
    module Replace_polymorphic_compare =
      Core_kernel__Core_int64.Replace_polymorphic_compare
    val comparator :
      (t, comparator_witness) Core_kernel__.Comparator.comparator
    module Map = Core_kernel__Core_int64.Map
    module Set = Core_kernel__Core_int64.Set
    val hash : t -> Core_kernel__.Import.int
    val hashable : t Core_kernel__.Hashable.Hashtbl.Hashable.t
    module Table = Core_kernel__Core_int64.Table
    module Hash_set = Core_kernel__Core_int64.Hash_set
    module Hash_queue = Core_kernel__Core_int64.Hash_queue
