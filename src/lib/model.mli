...
module Model : sig
  ...
  val get_fields_map_for_all_tables : conn:Mysql.dbd -> unit -> t list Core.Std.String.Map.t 
  val get_fields_for_given_table : ?conn:Mysql.dbd -> table_name:Core.Std.String.Map.Key.t -> (t list Core.Std.String.Map.t, string) Core.Std.Result.t 
